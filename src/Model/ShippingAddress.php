...
/**
 * A type that defines the fields for a shipping address. For restrictions, see <a
 * href="/api-docs/buy/order/overview.html#Shipping">Shipping restrictions</a>.<br
 * /><br /><span class="tablenote"><b>Note:</b> If the address cannot be validated,
 * a warning message will be returned.</span>.
 */
